...
Free grant:     Billable = max(0, records − 5,000) ÷ 1,000
```
...
- **Commitment tiers**: Available for Standard, CLU, Summarization, and TA4H features at 1M–25M volume. Connected container tiers are ~20% cheaper than Azure-hosted
