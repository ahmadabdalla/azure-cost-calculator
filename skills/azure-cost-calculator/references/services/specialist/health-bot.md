...
primaryCost: "Standard daily fee (×30) + MCU/message overage; Agent Tier per-action; Free tier available"
hasFreeGrant: true
...
### Health Bot — Agent Tier (per-action)
...
- **Standard tier includes daily MCU/message allowance** — overages billed per-unit above included allowance
